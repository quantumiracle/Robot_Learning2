...
'''
here it doesn't work with the worker for sampling as a class
it has to be a function for multiprocessing to work here!
'''
class Worker():
    def __init__(self):
...
if  __name__=='__main__':
    ...
    processes = [Process(target=workers[i].work, args=()) for i in range(num_workers)]

    # num_workers=2
    # processes = [Process(target=worker, args=()) for i in range(num_workers)]
